...
(function() 
{
   ...
   tinymce.create('tinymce.plugins.AfterTheDeadlinePlugin', 
   {
	  ...
	  else if (catOptions.indexOf("formes_valencianes")>=0)
	  {
	      ...
	      //Criteris administració valenciana.
//              enable = "AMERAR,LLANCAR,VERBS_I_ANTIHIATICA,TLL_TL,NADAR,MUNICIPIS_OFICIAL,EVITA_AQUEIX_EIXE,FORMES_VERBALS_PREFERIBLES,A_L_ABRIL_DE_1994,CEMENTERI,ARRANCAR,NUMERALS_VALENCIANS,REDO,TRAURE,PARTICIPIS_IT,SER_ESSER,ORDINALS_FORMALS,NAIXER2,HUI,XARRAR,NAIXER,PRE_IEC2017,EXIGEIX_PLURALS_SCOS,EXIGEIX_PLURALS_JOS,EXIGEIX_PLURALS_S,EXIGEIX_INFINITIUS_INDRE,EXIGEIX_INFINITIUS_ALDRE";
//              disable = "MUNICIPIS_VALENCIA,AL_INFINITIU,EVITA_INFINITIUS_INDRE,ORTO_IEC2017";
